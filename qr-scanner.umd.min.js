...
[d,k]=e._drawToCanvas(p,m,d,f);let q;if(c instanceof Worker){let g=c;b||e._postWorkerMessageSync(g,"inversionMode",[],"both");q=await new Promise((l,w)=>{let x,v,r,z=-1;v=t=>{t.data.id===z&&(g.removeEventListener("message",v),g.removeEventListener("error",r),clearTimeout(x),null!==t.data.data?l({data:t.data.data,cornerPoints:e._convertPoints(t.data.cornerPoints,m)}):w(e.NO_QR_CODE_FOUND))};r=t=>{g.removeEventListener("message",v);g.removeEventListener("error",r);clearTimeout(x);w("Scanner error: "+
(t?t.message||t:"Unknown Error"))};g.addEventListener("message",v);g.addEventListener("error",r);x=setTimeout(()=>r("timeout"),1E4);let y=k.getImageData(0,0,d.width,d.height);z=e._postWorkerMessageSync(g,"decode",[y.data.buffer],y)})}else q=await Promise.race([new Promise((g,l)=>window.setTimeout(()=>l("Scanner error: timeout"),1E4)),(async()=>{try{var [g]=await c.detect(d);if(!g)throw e.NO_QR_CODE_FOUND;return{data:g.rawValue,cornerPoints:e._convertPoints(g.cornerPoints,m)}}catch(l){g=l.message||
...
e._disableBarcodeDetector=!1;e._workerMessageId=0;u.QrScanner=e;Object.defineProperty(u,"__esModule",{value:!0})})
