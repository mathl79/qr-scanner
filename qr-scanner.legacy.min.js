...
d.onDecodeError&&(this._onDecodeError=d.onDecodeError);d.calculateScanRegion&&(this._calculateScanRegion=d.calculateScanRegion);this._preferredCamera=d.preferredCamera||this._preferredCamera;this._maxScansPerSecond=d.maxScansPerSecond||this._maxScansPerSecond;this._onPlay=this._onPlay.bind(this);this._onLoadedMetaData=this._onLoadedMetaData.bind(this);this._onVisibilityChange=this._onVisibilityChange.bind(this);this._updateOverlay=this._updateOverlay.bind(this);a.disablePictureInPicture=!0;a.playsInline=
!0;a.muted=!0;let f=!1;a.hidden&&(a.hidden=!1,f=!0);c=d.domTarget||document.body;c.contains(a)||(c.appendChild(a),f=!0);c=a.parentElement;if(d.highlightScanRegion||d.highlightCodeOutline){let g=!!d.overlay;this.$overlay=d.overlay||document.createElement("div");let k=this.$overlay.style;k.position="absolute";k.display="none";k.pointerEvents="none";this.$overlay.classList.add("scan-region-highlight");if(!g&&d.highlightScanRegion){this.$overlay.innerHTML='<svg class="scan-region-highlight-svg" viewBox="0 0 238 238" preserveAspectRatio="none" style="position:absolute;width:100%;height:100%;left:0;top:0;fill:none;stroke:#e9b213;stroke-width:4;stroke-linecap:round;stroke-linejoin:round"><path d="M31 2H10a8 8 0 0 0-8 8v21M207 2h21a8 8 0 0 1 8 8v21m0 176v21a8 8 0 0 1-8 8h-21m-176 0H10a8 8 0 0 1-8-8v-21"/></svg>';
...
c._preferredCamera&&(c._preferredCamera=a,yield c._restartVideoStream())})}static scanImage(a,c,d,f,g=!1,k=!1){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let n,p=!1;c&&("scanRegion"in c||"qrEngine"in c||"canvas"in c||"disallowCanvasResizing"in c||"alsoTryWithoutScanRegion"in c||"returnDetailedScanResult"in c)?(n=c.scanRegion,d=c.qrEngine,f=c.canvas,g=c.disallowCanvasResizing||!1,k=c.alsoTryWithoutScanRegion||!1,p=!0):c||d||f||g||k?console.warn("You're using a deprecated api for scanImage which will be removed in the future."):
console.warn("Note that the return type of scanImage will change in the future. To already switch to the new api today, you can pass returnDetailedScanResult: true.");let r=!!d;try{let l,q;[d,l]=yield Promise.all([d||b.createQrEngine(),b._loadImage(a)]);[f,q]=b._drawToCanvas(l,n,f,g);let m;if(d instanceof Worker){let h=d;r||b._postWorkerMessageSync(h,"inversionMode",[],"both");m=yield new Promise((t,z)=>{let x,v,w,y=-1;v=u=>{u.data.id===y&&(h.removeEventListener("message",v),h.removeEventListener("error",
w),clearTimeout(x),null!==u.data.data?t({data:u.data.data,cornerPoints:b._convertPoints(u.data.cornerPoints,n)}):z(b.NO_QR_CODE_FOUND))};w=u=>{h.removeEventListener("message",v);h.removeEventListener("error",w);clearTimeout(x);z("Scanner error: "+(u?u.message||u:"Unknown Error"))};h.addEventListener("message",v);h.addEventListener("error",w);x=setTimeout(()=>w("timeout"),1E4);let A=q.getImageData(0,0,f.width,f.height);y=b._postWorkerMessageSync(h,"decode",[A.data.buffer],A)})}else m=yield Promise.race([new Promise((h,
t)=>window.setTimeout(()=>t("Scanner error: timeout"),1E4)),(()=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){try{var [h]=yield d.detect(f);if(!h)throw b.NO_QR_CODE_FOUND;return{data:h.rawValue,cornerPoints:b._convertPoints(h.cornerPoints,n)}}catch(t){h=t.message||t;if(/not implemented|service unavailable/.test(h))return b._disableBarcodeDetector=!0,b.scanImage(a,{scanRegion:n,canvas:f,disallowCanvasResizing:g,alsoTryWithoutScanRegion:k});throw`Scanner error: ${h}`;}}))()]);return p?m:
m.data}catch(l){if(!n||!k)throw l;let q=yield b.scanImage(a,{qrEngine:d,canvas:f,disallowCanvasResizing:g});return p?q:q.data}finally{r||b._postWorkerMessage(d,"close")}})}setGrayscaleWeights(a,c,d,f=!0){b._postWorkerMessage(this._qrEnginePromise,"grayscaleWeights",{red:a,green:c,blue:d,useIntegerApproximation:f})}setInversionMode(a){b._postWorkerMessage(this._qrEnginePromise,"inversionMode",a)}static createQrEngine(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){a&&console.warn("Specifying a worker path is not required and not supported anymore.");
let c=()=>Promise.resolve().then(function(){return e}).then(f=>f.createWorker());if(!(!b._disableBarcodeDetector&&"BarcodeDetector"in window&&BarcodeDetector.getSupportedFormats&&(yield BarcodeDetector.getSupportedFormats()).includes("qr_code")))return c();let d=navigator.userAgentData;return d&&d.brands.some(({brand:f})=>/Chromium/i.test(f))&&/mac ?OS/i.test(d.platform)&&(yield d.getHighEntropyValues(["architecture","platformVersion"]).then(({architecture:f,platformVersion:g})=>/arm/i.test(f||"arm")&&
13<=parseInt(g||"13")).catch(()=>!0))?c():new BarcodeDetector({formats:["qr_code"]})})}_onPlay(){this._scanRegion=this._calculateScanRegion(this.$video);this._updateOverlay();this.$overlay&&(this.$overlay.style.display="");this._scanFrame()}_onLoadedMetaData(){this._scanRegion=this._calculateScanRegion(this.$video);this._updateOverlay()}_onVisibilityChange(){document.hidden?this.pause():this._active&&this.start()}_calculateScanRegion(a){let c=Math.round(2/3*Math.min(a.videoWidth,a.videoHeight));return{x:Math.round((a.videoWidth-
c)/2),y:Math.round((a.videoHeight-c)/2),width:c,height:c,downScaledWidth:this._legacyCanvasSize,downScaledHeight:this._legacyCanvasSize}}_updateOverlay(){requestAnimationFrame(()=>{if(this.$overlay){var a=this.$video,c=a.videoWidth,d=a.videoHeight,f=a.offsetWidth,g=a.offsetHeight,k=a.offsetLeft,n=a.offsetTop,p=window.getComputedStyle(a),r=p.objectFit,l=c/d,q=f/g;switch(r){case "none":var m=c;var h=d;break;case "fill":m=f;h=g;break;default:("cover"===r?l>q:l<q)?(h=g,m=h*l):(m=f,h=m/l),"scale-down"===
r&&(m=Math.min(m,c),h=Math.min(h,d))}var [t,z]=p.objectPosition.split(" ").map((v,w)=>{const y=parseFloat(v);return v.endsWith("%")?(w?g-h:f-m)*y/100:y});p=this._scanRegion.width||c;q=this._scanRegion.height||d;r=this._scanRegion.x||0;var x=this._scanRegion.y||0;l=this.$overlay.style;l.width=`${p/c*m}px`;l.height=`${q/d*h}px`;l.top=`${n+z+x/d*h}px`;d=/scaleX\(-1\)/.test(a.style.transform);l.left=`${k+(d?f-t-m:t)+(d?c-r-p:r)/c*m}px`;l.transform=a.style.transform}})}static _convertPoints(a,c){if(!c)return a;
...
yield navigator.mediaDevices.getUserMedia({video:g,audio:!1}),n=a._getFacingMode(k)||(g.facingMode?a._preferredCamera:"environment"===a._preferredCamera?"user":"environment");return{stream:k,facingMode:n}}catch(k){}throw"Camera not found.";})}_restartVideoStream(){const a=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){let c=a._paused;(yield a.pause(!0))&&!c&&a._active&&(yield a.start())})}static _stopVideoStream(a){for(let c of a.getTracks())c.stop(),a.removeTrack(c)}_setVideoMirror(a){this.$video.style.transform=
"scaleX("+("user"===a?-1:1)+")"}_getFacingMode(a){return(a=a.getVideoTracks()[0])?/rear|back|environment/i.test(a.label)?"environment":/front|user|face/i.test(a.label)?"user":null:null}static _drawToCanvas(a,c,d,f=!1){d=d||document.createElement("canvas");let g=c&&c.x?c.x:0,k=c&&c.y?c.y:0,n=c&&c.width?c.width:a.videoWidth||a.width,p=c&&c.height?c.height:a.videoHeight||a.height;f||(f=c&&c.downScaledWidth?c.downScaledWidth:n,c=c&&c.downScaledHeight?c.downScaledHeight:p,d.width!==f&&(d.width=f),d.height!==
c&&(d.height=c));c=d.getContext("2d",{alpha:!1});c.imageSmoothingEnabled=!1;c.drawImage(a,g,k,n,p,0,0,d.width,d.height);return[d,c]}static _loadImage(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){if(a instanceof Image)return yield b._awaitImageLoad(a),a;if(a instanceof HTMLVideoElement||a instanceof HTMLCanvasElement||a instanceof SVGImageElement||"OffscreenCanvas"in window&&a instanceof OffscreenCanvas||"ImageBitmap"in window&&a instanceof ImageBitmap)return a;if(a instanceof
File||a instanceof Blob||a instanceof URL||"string"===typeof a){let c=new Image;c.src=a instanceof File||a instanceof Blob?URL.createObjectURL(a):a.toString();try{return yield b._awaitImageLoad(c),c}finally{(a instanceof File||a instanceof Blob)&&URL.revokeObjectURL(c.src)}}else throw"Unsupported image type.";})}static _awaitImageLoad(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){a.complete&&0!==a.naturalWidth||(yield new Promise((c,d)=>{let f=g=>{a.removeEventListener("load",
f);a.removeEventListener("error",f);g instanceof ErrorEvent?d("Image load error"):c()};a.addEventListener("load",f);a.addEventListener("error",f)}))})}static _postWorkerMessage(a,c,d,f){return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return b._postWorkerMessageSync(yield a,c,d,f)})}static _postWorkerMessageSync(a,c,d,f){if(!(a instanceof Worker))return-1;let g=b._workerMessageId++;a.postMessage({id:g,type:c,data:f},d);return g}}b.DEFAULT_CANVAS_SIZE=400;b.NO_QR_CODE_FOUND="No QR code found";
